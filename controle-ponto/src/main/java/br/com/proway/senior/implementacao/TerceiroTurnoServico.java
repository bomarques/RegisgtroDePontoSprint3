...
public class TerceiroTurnoServico implements JornadaServico {
	
	protected final List<LocalTime> HORARIO_TURNO3 = Arrays.asList(LocalTime.of(22, 0), LocalTime.of(2, 0),
	...
	public boolean fechaJornada(Jornada jornada) {
		LocalTime horario = LocalTime.of(12, 00, 00);
		if (jornada.getPontos().size() == HORARIO_TURNO3.size() || LocalTime.now() == horario) {
