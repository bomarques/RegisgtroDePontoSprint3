...
public class ComercialTurnoServico implements JornadaServico {

	protected final List<LocalTime> HORARIO_TURNO_COMERCIAL = Arrays.asList(LocalTime.of(8, 0), LocalTime.of(12, 0),
	 ...
	 * 
	 * @param idPessoa int, recebe usu�rio que est� batendo o ponto
	 * @param batidaPonto LocalDateTime, recebe o hor�rio e a data da batida do ponto
	 * 
	 ...
	 * A jornada de trabalho � fechada a partir das batidas pre definidas ou
	 ...
	 *  
	 *  @return boolean Retorna false quando a Jornada n�o precisa ser fechada,
	...
	public boolean fechaJornada(Jornada jornada) {
		...
		if (jornada.getPontos().size() == HORARIO_TURNO_COMERCIAL.size() || LocalTime.now() == horario) {
